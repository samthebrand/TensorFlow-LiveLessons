...
5. Start Docker, e.g., by using Finder to navigate to your Applications folder and double-clicking on the Docker icon (if you haven't used Docker before you'll have to create a free account and sign in via the web).
